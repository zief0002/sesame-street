...
Import the [riverview.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/riverview.csv) data into an object named `city`. Also, examine the [data codebook](https://zief0002.github.io/miniature-garbanzo/codebooks/riverview.html) so you are familiar with the different attributes.
...
Write syntax to create the following plot, which was created using the [gapminder.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/gapminder.csv) data. Write this syntax in a script file. Be sure you are using good coding practices and putting each layer on a different line.
...
#| fig-align: 'center'
#| out-width: '90%'
#| fig-cap: "Life expectancy versus per-peron income for 193 countries. The size of the observations is based on population."
#| message: false
...
Add text to the plot you created in Task 6 tolabel the country with the highest life expectancy.
