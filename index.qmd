...
- You will work from the lab manual every day in class. To download a PDF copy of the lab manual, click [here](https://github.com/zief0002/statistical-thinking/blob/master/statistical-thinking-v4_4.pdf?raw=true).

- There are several data sets used in the lab manual, as well as in EPSY 3264 assignments. To download a ZIP file to your computer that includes all the data sets, click [this link](https://github.com/zief0002/statistical-thinking/blob/master/tp3-data.zip?raw=true). Once the ZIP file has been downloaded to your computer, double-click the ZIP file to unzip it and access the materials. (On a Windows computer, right-click the folder, select `Extract All...`, and then follow the instructions.)
