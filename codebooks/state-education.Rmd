...
This data, stored in [state-education.csv](https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/state-education.csv) includes state-level aggregate data on six attributes. The attributes, collected for all 50 states and the District of Columbia, are:
...
# Import Data
state_educ = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/miniature-garbanzo/main/data/state-education.csv")
